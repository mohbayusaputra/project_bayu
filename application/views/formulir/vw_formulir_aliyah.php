        ...
        <div class="card-body container-xxl py-10 px-3">
            <div class="d-flex align-items-center justify-content-center">
                <span class="position-relative d-inline-block fs-1">
                    ...
                    <div class="text-white fw-bold opacity-75-hover">Formulir Pendaftaran Aliyah</div>
                    <div
...
<div class="form-container">
    <form action="<?= base_url('formulir/handleFormSubmission'); ?>" method="post" id="dataPribadiForm">
        <h1>Data Pribadi</h1>
        <hr>
